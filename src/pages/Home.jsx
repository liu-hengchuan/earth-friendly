  ...
  return (
    <>
      ...
      <div class="main-content-area">
              ...
              <div class="row">
                ...
                <div className="col-lg-6">
                  <div class="about-content pr-30 pl-30 pl-md--0 pr-md--0" data-tm-padding-top="55">
                    <div className="tm-sc-section-title section-title mb-50">
        ...
        {/* Section: Service */}
        <section dataTmBgColor="#f4f3ef">
          <div className="container">
            <div className="tm-sc-section-title section-title text-center mb-50">
              <div class="row">
                <div class="col-lg-5 m-auto">
                  <div class="title-wrapper mb-0">
                    <div className="title-icon-img line-height-1">
                      <img src="/images/icons/title-icon.png" alt="Image" />
                    </div>
                    <h2 class="title">What We Do</h2>
                    <p className="paragraph mb-0">Lorem ipsum dolor sit amet nsectetur cing elituspe ndisse suscipit sagitis leo sit.</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="section-content">
              <div class="row">
                <div className="col-sm-6 col-xl-3">
                  <div className="service-item-current-style1 text-center position-relative z-index-1 overflow-hidden tm-animation move-right animate mb-lg-30">
                    <div className="service-icon mb-25 text-center d-inline-block">
                      <img className="icon" src="/images/icons/s01.png" alt="Icon" />
                    </div>
                    <h6 className="service-title mb-25 mt-0 mb-lg--0">Eco System</h6>
                    <p className="service-details font-size-15 mb-0">Lorem ipsum is free text used by neque porro est qui dolorem ipsum quia.</p>
                    <div className="floating-object-1 tm-animation-floating" data-tm-bg-img="/images/shape/service-01.png"></div>
                    <div className="line-style"></div>
                  </div>
                </div>
                <div className="col-sm-6 col-xl-3">
                  <div className="service-item-current-style1 text-center position-relative z-index-1 overflow-hidden tm-animation move-right2 animate mb-lg-30">
                    <div className="service-icon mb-25 text-center d-inline-block">
                      <img className="icon" src="/images/icons/s02.png" alt="Icon" />
                    </div>
                    <h6 className="service-title mb-25 mt-0 mb-lg--0">Recycling</h6>
                    <p className="service-details font-size-15 mb-0">Lorem ipsum is free text used by neque porro est qui dolorem ipsum quia.</p>
                    <div className="floating-object-1 tm-animation-spin-half" data-tm-bg-img="/images/shape/service-01.png"></div>
                    <div className="line-style"></div>
                  </div>
                </div>
                <div className="col-sm-6 col-xl-3">
                  <div className="service-item-current-style1 text-center position-relative z-index-1 overflow-hidden tm-animation move-right3 animate mb-lg-30">
                    <div className="service-icon mb-25 text-center d-inline-block">
                      <img className="icon" src="/images/icons/s03.png" alt="Icon" />
                    </div>
                    <h6 className="service-title mb-25 mt-0 mb-lg--0">Water Refine</h6>
                    <p className="service-details font-size-15 mb-0">Lorem ipsum is free text used by neque porro est qui dolorem ipsum quia.</p>
                    <div className="floating-object-1 tm-animation-floating" data-tm-bg-img="/images/shape/service-01.png"></div>
                    <div className="line-style"></div>
                  </div>
                ...
                <div className="col-sm-6 col-xl-3">
                  <div className="service-item-current-style1 text-center position-relative z-index-1 overflow-hidden tm-animation move-right4 animate mb-lg-30">
                    <div className="service-icon mb-25 text-center d-inline-block">
                      <img className="icon" src="/images/icons/s04.png" alt="Icon" />
                    </div>
                    <h6 className="service-title mb-25 mt-0 mb-lg--0">Save Animals</h6>
                    <p className="service-details font-size-15 mb-0">Lorem ipsum is free text used by neque porro est qui dolorem ipsum quia.</p>
                    <div className="floating-object-1 tm-animation-spin-half" data-tm-bg-img="/images/shape/service-01.png"></div>
                    <div className="line-style"></div>
                  </div>
                ...
                <div class="col-lg-4">
                  <div class="tm-sc-section-title section-title mb-0 pr-70 pr-lg--0 mb-md-40">
                    <div class="title-wrapper mb-0">
                      ...
                      <h2 className="title">Our Fundraising Campaigns</h2>
                      <p className="paragraph mb-0">Lorem ipsum dolor sit amet nsectetur cing elituspe ndisse suscipit sagitis leo sit.</p>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="tm-owl-carousel-2col owl-carousel owl-theme" data-autoplay="false" data-loop="true" data-duration="6000" data-smartspeed="300" data-margin="30" data-stagepadding="20" data-nav="true">
                        ...
                        <div class="causes-item-current-style1">
                          <div class="causes-item">
                            <div class="causes-thumb">
                              <img src="/images/causes/c01.jpg" alt="Image" className="w-100" />
                            </div>
                      ...
                      <div class="item">
                        <div class="causes-item-current-style1">
                          <div class="causes-item">
                            <div class="causes-thumb">
                              <img src="/images/causes/c02.jpg" alt="Image" className="w-100" />
                            </div>
                            <div class="causes-details">
                      ...
                      <div class="item">
                        <div class="causes-item-current-style1">
                          <div class="causes-item">
                            <div class="causes-thumb">
                              <img src="/images/causes/c03.jpg" alt="Image" className="w-100" />
                            </div>
                            <div class="causes-details">
        ...
        {/* Start Divider */}
        <section className="text-center bg-img-cover bg-img-center-top" data-tm-bg-img="/images/bg/bg1.jpg">
          <div class="container">
            <div class="row">
        ...
        <section>
          <div class="container">
            <div class="section-content">
              <div class="row">
                <div className="col-lg-6">
                  <div className="layer-image-wrapper layer-image-current-style1 position-relative mr-70 mr-lg--0 mb-md-60">
                    <div className="layer-image mr-60 mr-sm--0">
                      <img className="w-100" src="/images/photos/project-01.jpg" alt="Image" />
                    </div>
                    <div class="successfull-project-box-style1 bg-theme-colored1">
                      <img className="icon mb-5" src="/images/icons/p01.png" alt="Image" />
                      <h2 className="success-number text-white mt-0 mb-5">8800</h2>
                      <h6 className="title text-theme-colored2 m-0">Successfully<br />Project</h6>
                    </div>
                    <div className="become-volunteer-style1">
                ...
                <div className="col-lg-6">
                  <div className="tm-sc-section-title section-title mb-50">
                    <div class="title-wrapper mb-0">
                      ...
                      <h2 className="title">Join the Race to Make the World a Better Place</h2>
                      <p className="paragraph mb-0">Lorem ipsum dolor sit amet nsectetur cing elituspe ndisse suscipit sagitis leo sit. pain and trouble that are bound to ensue weakness of will, which is the same as saying through shrinking.</p>
                    </div>
                  </div>
                  <div className="service-list-item-style1 mb-10">
                    <span className="number">01</span>
                    <p className="mb-0">Save Ecology Begin by Planting Trees</p>
                  </div>
                  <div className="service-list-item-style1 mb-10">
                    <span className="number">02</span>
                    <p className="mb-0">Eco System amet  for Global Warnings</p>
                  </div>
                  <div className="service-list-item-style1">
                    <span className="number">03</span>
                    <p className="mb-0">People to Clean the Air and Safe Rivers</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="section-content">
              <div class="row">
                <div className="col-lg-4">
                  <div className="testimonial-item mb-md-150">
                    <div className="author-text mb-30">I was very impresed by the kologi service lorem ipsum is simply free text used by copytyping refreshing. Neque porro est qui dolorem ipsum quia.</div>
                    <div className="author-info clearfix">
                      <h5 className="name mt-0 mb-0">Mike Hardson</h5>
                      <span className="job-position">Donater</span>
                    </div>
            ...
            <div class="section-content">
              <div class="row">
                <div class="col-lg-6 align-self-lg-center align-self-xl-start">
                  <div class="thumb">
                    <img className="w-md-100" src="/images/photos/newsletter-01.jpg" alt="Image" />
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="newsletter-form-current-style1 text-center" data-tm-bg-color="#f4f3ef">
                    ...
                    <form id="mailchimp-subscription-form2" className="newsletter-form m-0 p-0">
                      <input type="email" id="mce-EMAIL" className="form-control" placeholder="Email Address" name="EMAIL" value="" />
                      <button type="submit" className="btn btn-lg btn-theme-colored1 btn-flat d-block w-100 mt-20">Subscribe Now</button>
                    </form>
                    ...
                    <script dangerouslySetInnerHTML={{ __html: `
                      ...
                      window.mc4wp.forms['mailchimp-subscription-form2'] = {
                        options: {
                      ...
                      function mailChimpCallBack(resp) {
                        var form = document.getElementById('mailchimp-subscription-form2');
                        ...
                        responseDiv.className = 'alert ' + (resp.result === 'success' ? 'alert-success' : 'alert-danger');
                        responseDiv.innerHTML = '<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>' + resp.msg;
