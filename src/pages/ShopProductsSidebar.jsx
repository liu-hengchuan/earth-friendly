                      ...
                      <ul id="main-nav" className="menuzord-menu">
                        ...
                        <li><a href="#">Pages</a>
                          <ul className="dropdown">
                            ...
                            <li className="active"><Link to="/shop-products-sidebar">Shop</Link></li>
              ...
              <div class="col-md-3">
                <div className="sidebar-widget">
                  ...
                  <ul className="categories-list">
                    <li><a href="#">Organic Products</a> (5)</li>
                    <li><a href="#">Eco-Friendly</a> (3)</li>
                    <li><a href="#">Recycled</a> (2)</li>
                    <li><a href="#">Sustainable</a> (4)</li>
                    <li><a href="#">Zero Waste</a> (1)</li>
                  </ul>
                </div>
                <div className="sidebar-widget">
                  ...
                  <div class="row">
                    <div className="col-md-4">
                      <div className="product-item">
                        ...
                        <div className="product-info">
                          <h4 class="title"><a href="#">Organic T-Shirt</a></h4>
                          <div className="price">£25.00</div>
                          <a href="#" className="btn btn-theme-colored1 btn-sm">Add to Cart</a>
                        </div>
                      </div>
                    </div>
                    <div className="col-md-4">
                      <div className="product-item">
                        ...
                        <div className="product-info">
                          <h4 class="title"><a href="#">Reusable Bottle</a></h4>
                    ...
                    <div className="col-md-4">
                      <div className="product-item">
                        ...
                        <div className="product-info">
                          <h4 class="title"><a href="#">Bamboo Toothbrush</a></h4>
                    ...
                    <div className="col-md-4">
                      <div className="product-item">
                        ...
                        <div className="product-info">
                          <h4 class="title"><a href="#">Cotton Tote Bag</a></h4>
                    ...
                    <div className="col-md-4">
                      <div className="product-item">
                        ...
                        <div className="product-info">
                          <h4 class="title"><a href="#">Beeswax Wraps</a></h4>
                    ...
                    <div className="col-md-4">
                      <div className="product-item">
                        <div className="product-thumb">
                          <img src="/images/shop/product-6.jpg" alt="Image" />
                        </div>
                        <div className="product-info">
                          <h4 class="title"><a href="#">Solar Charger</a></h4>
