        ...
        <section id="inner-header" data-tm-bg-img="/images/bg/bg1.jpg">
          <div class="container">
            <div class="section-content">
              <h2 class="page-title">News Grid</h2>
              <ol class="breadcrumb">
            ...
            <div class="row">
              <div className="col-lg-4 col-md-6">
                <div class="news-block">
                  ...
                  <div className="news-content">
                    <h4 className="title"><Link to="/news-details">Increasing the amount of clean energy</Link></h4>
                    ...
                    <Link to="/news-details" className="btn btn-theme-colored1 btn-flat">Read More</Link>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 col-md-6">
                <div class="news-block">
                  ...
                  <div class="news-content">
                    <h4 className="title"><Link to="/news-details">The solution to climate change</Link></h4>
                    <p>Lorem ipsum dolor sit amet, notted consectetur adipisi elit sed do eiusmod temor sit amet dolor incididunt labore magna aliquaenim sed do eiusmod tempor incididunt.</p>
                    <div class="news-meta">
                      <span class="date"><i class="fa fa-calendar"></i> 01 Feb, 2021</span>
                      <span class="author"><i class="fa fa-user"></i> Admin</span>
              ...
              <div class="col-lg-4 col-md-6">
                <div className="news-block">
                  ...
                  <div className="news-content">
                    <h4 className="title"><Link to="/news-details">Save the tigers</Link></h4>
                    <p>Lorem ipsum dolor sit amet, notted consectetur adipisi elit sed do eiusmod temor sit amet dolor incididunt labore magna aliquaenim sed do eiusmod tempor incididunt.</p>
                    <div class="news-meta">
                      <span class="date"><i class="fa fa-calendar"></i> 01 Feb, 2021</span>
                      <span class="author"><i class="fa fa-user"></i> Admin</span>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="news-block">
                  ...
                  <div className="news-content">
                    <h4 className="title"><Link to="/news-details">Clean up our oceans</Link></h4>
                    <p>Lorem ipsum dolor sit amet, notted consectetur adipisi elit sed do eiusmod temor sit amet dolor incididunt labore magna aliquaenim sed do eiusmod tempor incididunt.</p>
                    <div class="news-meta">
                      <span class="date"><i class="fa fa-calendar"></i> 01 Feb, 2021</span>
                      <span class="author"><i class="fa fa-user"></i> Admin</span>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="news-block">
                  <div className="news-thumb">
                    <img src="/images/photos/news-5.jpg" alt="Image" />
                    <div className="news-category">
                      <span>Air Quality</span>
                    </div>
                  </div>
                  <div className="news-content">
                    <h4 className="title"><Link to="/news-details">Improve air quality</Link></h4>
                    <p>Lorem ipsum dolor sit amet, notted consectetur adipisi elit sed do eiusmod temor sit amet dolor incididunt labore magna aliquaenim sed do eiusmod tempor incididunt.</p>
                    <div class="news-meta">
                      <span class="date"><i class="fa fa-calendar"></i> 01 Feb, 2021</span>
                      <span class="author"><i class="fa fa-user"></i> Admin</span>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="news-block">
                  <div className="news-thumb">
                    <img src="/images/photos/news-6.jpg" alt="Image" />
                    <div className="news-category">
                      <span>Forests</span>
                    </div>
                  </div>
                  <div className="news-content">
                    <h4 className="title"><Link to="/news-details">Protect our forests</Link></h4>
                    <p>Lorem ipsum dolor sit amet, notted consectetur adipisi elit sed do eiusmod temor sit amet dolor incididunt labore magna aliquaenim sed do eiusmod tempor incididunt.</p>
                    <div class="news-meta">
                      <span class="date"><i class="fa fa-calendar"></i> 01 Feb, 2021</span>
                      <span class="author"><i class="fa fa-user"></i> Admin</span>
