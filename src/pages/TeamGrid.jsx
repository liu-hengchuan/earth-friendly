        ...
        <section id="inner-header" data-tm-bg-img="/images/bg/bg1.jpg">
          <div className="container">
            <div class="section-content">
              <h2 class="page-title">Team Grid</h2>
              <ol class="breadcrumb">
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-4 col-md-6">
                <div class="team-block team-block-style-2">
                  ...
                  <div class="team-content">
                    <h5 class="name"><Link to="/team-details">John Doe</Link></h5>
                    <span class="position">Environmental Engineer</span>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 col-md-6">
                <div class="team-block team-block-style-2">
                  ...
                  <div class="team-content">
                    <h5 class="name"><Link to="/team-details">Jane Smith</Link></h5>
                    <span class="position">Conservationist</span>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 col-md-6">
                <div class="team-block team-block-style-2">
                  ...
                  <div class="team-content">
                    <h5 class="name"><Link to="/team-details">Bob Johnson</Link></h5>
                    <span class="position">Wildlife Biologist</span>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 col-md-6">
                <div class="team-block team-block-style-2">
                  ...
                  <div class="team-content">
                    <h5 class="name"><Link to="/team-details">Alice Williams</Link></h5>
                    <span class="position">Sustainability Expert</span>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 col-md-6">
                <div class="team-block team-block-style-2">
                  ...
                  <div class="team-content">
                    <h5 class="name"><Link to="/team-details">Charlie Brown</Link></h5>
                    <span class="position">Ecology Researcher</span>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 col-md-6">
                <div class="team-block team-block-style-2">
                  ...
                  <div class="team-content">
                    <h5 class="name"><Link to="/team-details">Diana Prince</Link></h5>
                    <span class="position">Green Technology Specialist</span>
                  </div>
                </div>
              </div>
            </div>
