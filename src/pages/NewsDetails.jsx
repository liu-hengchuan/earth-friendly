              ...
              <div class="col-md-8">
                <div className="news-details">
                  ...
                  <div className="news-content">
                    <h3 className="title">Increasing the amount of clean energy</h3>
                    <div className="news-meta">
                      <span className="date"><i className="fa fa-calendar"></i> 01 Feb, 2021</span>
                      <span className="author"><i className="fa fa-user"></i> Admin</span>
                ...
                <div className="sidebar-widget">
                  ...
                  <ul className="recent-post clearfix">
                    ...
                    <li className="clearfix">
                      ...
                      <div className="post-data">
                        <h6 className="title"><Link to="/news-details">Save the tigers</Link></h6>
                        <p className="mb-0 date">01 Feb, 2021</p>
                      </div>
                    </li>
                    <li className="clearfix">
                      <div className="post-thumb">
                      ...
                      <div className="post-data">
                        <h6 className="title"><Link to="/news-details">Clean up our oceans</Link></h6>
                        <p className="mb-0 date">01 Feb, 2021</p>
                      </div>
                    </li>
                  </ul>
