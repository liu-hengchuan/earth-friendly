            ...
            <div class="row">
              <div class="col-lg-4 col-md-6">
                <div class="news-block">
                  ...
                  <div class="news-content">
                    <h4 class="title"><Link to="/news-details">Increasing the amount of clean energy</Link></h4>
              ...
              <div class="col-lg-4 col-md-6">
                <div class="news-block">
                  ...
                  <div class="news-content">
                    <h4 class="title"><Link to="/news-details">The solution to climate change</Link></h4>
                    <p>Lorem ipsum dolor sit amet, notted consectetur adipisi elit sed do eiusmod temor sit amet dolor incididunt labore magna aliquaenim sed do eiusmod tempor incididunt.</p>
                    <div class="news-meta">
                      <span class="date"><i class="fa fa-calendar"></i> 01 Feb, 2021</span>
                      <span class="author"><i class="fa fa-user"></i> Admin</span>
              ...
              <div class="col-lg-4 col-md-6">
                <div class="news-block">
                  ...
                  <div class="news-content">
                    <h4 class="title"><Link to="/news-details">Save the tigers</Link></h4>
                    <p>Lorem ipsum dolor sit amet, notted consectetur adipisi elit sed do eiusmod temor sit amet dolor incididunt labore magna aliquaenim sed do eiusmod tempor incididunt.</p>
                    <div class="news-meta">
                      <span class="date"><i class="fa fa-calendar"></i> 01 Feb, 2021</span>
                      <span class="author"><i class="fa fa-user"></i> Admin</span>
              ...
              <div class="col-lg-4 col-md-6">
                <div class="news-block">
                  ...
                  <div class="news-content">
                    <h4 class="title"><Link to="/news-details">Clean up our oceans</Link></h4>
                    <p>Lorem ipsum dolor sit amet, notted consectetur adipisi elit sed do eiusmod temor sit amet dolor incididunt labore magna aliquaenim sed do eiusmod tempor incididunt.</p>
                    <div class="news-meta">
                      <span class="date"><i class="fa fa-calendar"></i> 01 Feb, 2021</span>
                      <span class="author"><i class="fa fa-user"></i> Admin</span>
              ...
              <div class="col-lg-4 col-md-6">
                <div class="news-block">
                  ...
                  <div class="news-content">
                    <h4 class="title"><Link to="/news-details">Improve air quality</Link></h4>
                    <p>Lorem ipsum dolor sit amet, notted consectetur adipisi elit sed do eiusmod temor sit amet dolor incididunt labore magna aliquaenim sed do eiusmod tempor incididunt.</p>
                    <div class="news-meta">
                      <span class="date"><i class="fa fa-calendar"></i> 01 Feb, 2021</span>
                      <span class="author"><i class="fa fa-user"></i> Admin</span>
              ...
              <div class="col-lg-4 col-md-6">
                <div class="news-block">
                  ...
                  <div class="news-content">
                    <h4 class="title"><Link to="/news-details">Protect our forests</Link></h4>
                    <p>Lorem ipsum dolor sit amet, notted consectetur adipisi elit sed do eiusmod temor sit amet dolor incididunt labore magna aliquaenim sed do eiusmod tempor incididunt.</p>
                    <div class="news-meta">
                      <span class="date"><i class="fa fa-calendar"></i> 01 Feb, 2021</span>
                      <span class="author"><i class="fa fa-user"></i> Admin</span>
