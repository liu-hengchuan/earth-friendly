            ...
            <div className="row">
              <div className="col-lg-4">
                <div className="team-member-details">
                  ...
                  <div className="member-info">
                    ...
                    <span className="position">Environmental Engineer</span>
                    <div className="member-contact-info">
                      <ul class="list-unstyled">
                        <li><i className="fa fa-phone"></i> +440-98-5298</li>
                        <li><i className="fa fa-envelope"></i> john@example.com</li>
              ...
              <div className="col-lg-8">
                <div className="team-member-description">
                  ...
                  <p>Lorem ipsum dolor sit amet, notted consectetur adipisi elit sed do eiusmod temor sit amet dolor incididunt labore magna aliquaenim sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                  <h5>Expertise</h5>
                  <ul className="list-unstyled list-inline">
                    <li className="list-inline-item"><i className="fa fa-check"></i> Environmental Engineering</li>
                    <li className="list-inline-item"><i className="fa fa-check"></i> Sustainability</li>
                    <li className="list-inline-item"><i className="fa fa-check"></i> Renewable Energy</li>
                    <li className="list-inline-item"><i className="fa fa-check"></i> Climate Change</li>
                  </ul>
                  <h5>Experience</h5>
                  <div className="experience">
                    <div className="exp-item">
                      <h6>Environmental Engineer</h6>
                      <span>GreenTech Solutions | 2018 - Present</span>
                      <p>Lorem ipsum dolor sit amet, notted consectetur adipisi elit sed do eiusmod temor sit amet dolor incididunt labore magna aliquaenim.</p>
                    </div>
                    <div className="exp-item">
                      <h6>Sustainability Consultant</h6>
                      <span>EcoConsult | 2015 - 2018</span>
                      <p>Lorem ipsum dolor sit amet, notted consectetur adipisi elit sed do eiusmod temor sit amet dolor incididunt labore magna aliquaenim.</p>
                    </div>
                  </div>
                </div>
