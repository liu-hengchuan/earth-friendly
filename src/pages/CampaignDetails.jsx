            ...
            <div class="row">
              <div class="col-md-8">
                <div className="campaign-details">
                  ...
                  <div className="campaign-content">
                    <h3 className="title">Clean Energy for All</h3>
                    <div className="campaign-meta">
                      <span className="date"><i className="fa fa-calendar"></i> 01 Feb, 2021</span>
                      <span className="location"><i className="fa fa-map-marker"></i> Melbourne</span>
                      <span className="category"><i className="fa fa-tag"></i> Environment</span>
                    </div>
                    ...
                    <ul>
                      ...
                      <li>Create jobs in the clean energy sector</li>
                    </ul>
                    <h4>How You Can Help</h4>
                    <p>There are many ways you can get involved in our campaign. You can:</p>
                    <ul>
              ...
              <div class="col-md-4">
                <div class="sidebar-widget">
                  <h4 class="widget-title">Donate Now</h4>
                  <div class="donate-form">
                    <form action="#" method="post">
                      ...
                      <button type="submit" className="btn btn-theme-colored1 btn-flat btn-block">Donate</button>
                    </form>
                  </div>
                </div>
                <div class="sidebar-widget">
                  <h4 class="widget-title">Recent Campaigns</h4>
                  <ul className="recent-post clearfix">
                    <li className="clearfix">
                      ...
                      <div className="post-data">
                        <h6 className="title"><Link to="/campaign-details">Save the Tigers</Link></h6>
                    ...
                    <li className="clearfix">
                      ...
                      <div class="post-data">
                        <h6 className="title"><Link to="/campaign-details">Fight Climate Change</Link></h6>
                        <p class="mb-0 date">01 Feb, 2021</p>
                      </div>
                    </li>
                    <li className="clearfix">
                      ...
                      <div class="post-data">
                        <h6 className="title"><Link to="/campaign-details">Protect Our Forests</Link></h6>
                        <p class="mb-0 date">01 Feb, 2021</p>
                      </div>
                    </li>
                  </ul>
