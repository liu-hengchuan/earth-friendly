                  ...
                  <div className="col-sm-auto ms-auto pr-0 align-self-center">
                    <nav id="top-primary-nav" className="menuzord theme-color1" data-effect="fade" data-animation="none" data-align="right">
                      <ul id="main-nav" className="menuzord-menu">
                        ...
                        <li className="active"><a href="#">Campaigns</a>
                          <ul className="dropdown">
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-4 col-md-6">
                <div class="campaign-block">
                  <div class="campaign-thumb">
                    <img src="/images/campaign/campaign-1.jpg" alt="Image" />
                    <div class="campaign-category">
                      <span>Environment</span>
                    </div>
                  </div>
                  <div class="campaign-content">
                    <h4 className="title"><Link to="/campaign-details">Clean Energy for All</Link></h4>
                    <p>Lorem ipsum dolor sit amet, notted consectetur adipisi elit sed do eiusmod temor sit amet dolor incididunt labore magna aliquaenim sed do eiusmod tempor incididunt.</p>
                    <div class="campaign-meta">
                      <span class="date"><i class="fa fa-calendar"></i> 01 Feb, 2021</span>
                      <span class="location"><i class="fa fa-map-marker"></i> Melbourne</span>
                    </div>
                    <Link to="/campaign-details" className="btn btn-theme-colored1 btn-flat">Read More</Link>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 col-md-6">
                <div class="campaign-block">
                  <div class="campaign-thumb">
                    <img src="/images/campaign/campaign-2.jpg" alt="Image" />
                    <div class="campaign-category">
                      <span>Wildlife</span>
                    </div>
                  </div>
                  <div class="campaign-content">
                    <h4 className="title"><Link to="/campaign-details">Save the Tigers</Link></h4>
                    <p>Lorem ipsum dolor sit amet, notted consectetur adipisi elit sed do eiusmod temor sit amet dolor incididunt labore magna aliquaenim sed do eiusmod tempor incididunt.</p>
                    <div class="campaign-meta">
                      <span class="date"><i class="fa fa-calendar"></i> 01 Feb, 2021</span>
                      <span class="location"><i class="fa fa-map-marker"></i> Sydney</span>
                    </div>
                    <Link to="/campaign-details" className="btn btn-theme-colored1 btn-flat">Read More</Link>
                  </div>
                </div>
              ...
              <div class="col-lg-4 col-md-6">
                <div class="campaign-block">
                  <div class="campaign-thumb">
                    <img src="/images/campaign/campaign-3.jpg" alt="Image" />
                    <div class="campaign-category">
                      <span>Climate Change</span>
                    </div>
                  </div>
                  <div class="campaign-content">
                    <h4 className="title"><Link to="/campaign-details">Fight Climate Change</Link></h4>
                    <p>Lorem ipsum dolor sit amet, notted consectetur adipisi elit sed do eiusmod temor sit amet dolor incididunt labore magna aliquaenim sed do eiusmod tempor incididunt.</p>
                    <div class="campaign-meta">
                      <span class="date"><i class="fa fa-calendar"></i> 01 Feb, 2021</span>
                      <span class="location"><i class="fa fa-map-marker"></i> Brisbane</span>
                    </div>
                    <Link to="/campaign-details" className="btn btn-theme-colored1 btn-flat">Read More</Link>
                  </div>
                </div>
              ...
              <div class="col-lg-4 col-md-6">
                <div class="campaign-block">
                  <div class="campaign-thumb">
                    <img src="/images/campaign/campaign-4.jpg" alt="Image" />
                    <div class="campaign-category">
                      <span>Conservation</span>
                    </div>
                  </div>
                  <div class="campaign-content">
                    <h4 className="title"><Link to="/campaign-details">Protect Our Forests</Link></h4>
                    <p>Lorem ipsum dolor sit amet, notted consectetur adipisi elit sed do eiusmod temor sit amet dolor incididunt labore magna aliquaenim sed do eiusmod tempor incididunt.</p>
                    <div class="campaign-meta">
                      <span class="date"><i class="fa fa-calendar"></i> 01 Feb, 2021</span>
                      <span class="location"><i class="fa fa-map-marker"></i> Perth</span>
                    </div>
                    <Link to="/campaign-details" className="btn btn-theme-colored1 btn-flat">Read More</Link>
                  </div>
                </div>
              ...
              <div class="col-lg-4 col-md-6">
                <div class="campaign-block">
                  <div class="campaign-thumb">
                    <img src="/images/campaign/campaign-5.jpg" alt="Image" />
                    <div class="campaign-category">
                      <span>Ocean</span>
                    </div>
                  </div>
                  <div class="campaign-content">
                    <h4 className="title"><Link to="/campaign-details">Clean Our Oceans</Link></h4>
                    <p>Lorem ipsum dolor sit amet, notted consectetur adipisi elit sed do eiusmod temor sit amet dolor incididunt labore magna aliquaenim sed do eiusmod tempor incididunt.</p>
                    <div class="campaign-meta">
                      <span class="date"><i class="fa fa-calendar"></i> 01 Feb, 2021</span>
                      <span class="location"><i class="fa fa-map-marker"></i> Adelaide</span>
                    </div>
                    <Link to="/campaign-details" className="btn btn-theme-colored1 btn-flat">Read More</Link>
                  </div>
                </div>
              ...
              <div class="col-lg-4 col-md-6">
                <div class="campaign-block">
                  <div class="campaign-thumb">
                    <img src="/images/campaign/campaign-6.jpg" alt="Image" />
                    <div class="campaign-category">
                      <span>Air Quality</span>
                    </div>
                  </div>
                  <div class="campaign-content">
                    <h4 className="title"><Link to="/campaign-details">Improve Air Quality</Link></h4>
                    <p>Lorem ipsum dolor sit amet, notted consectetur adipisi elit sed do eiusmod temor sit amet dolor incididunt labore magna aliquaenim sed do eiusmod tempor incididunt.</p>
                    <div class="campaign-meta">
                      <span class="date"><i class="fa fa-calendar"></i> 01 Feb, 2021</span>
                      <span class="location"><i class="fa fa-map-marker"></i> Canberra</span>
                    </div>
                    <Link to="/campaign-details" className="btn btn-theme-colored1 btn-flat">Read More</Link>
                  </div>
                </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <nav aria-label="Page navigation">
                  <ul class="pagination theme-colored m-0">
