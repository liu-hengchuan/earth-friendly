              ...
              <div className="col-lg-4 col-md-6">
                <div className="testimonial-block">
                  ...
                  <div className="testimonial-author">
                    ...
                    <div className="author-info">
                      <h5 className="name">Jane Smith</h5>
                      <span className="position">Conservationist</span>
                    </div>
                  </div>
                </div>
              </div>
              <div className="col-lg-4 col-md-6">
                <div className="testimonial-block">
                  ...
                  <div className="testimonial-author">
                    ...
                    <div className="author-info">
                      <h5 className="name">Bob Johnson</h5>
                      <span className="position">Wildlife Biologist</span>
                    </div>
                  </div>
                </div>
              </div>
