                        ...
                        <div className="top-nav-mini-cart-icon-container">
                          <div className="top-nav-mini-cart-icon-contents">
                            ...
                            <div className="dropdown-content">
                              ...
                              <p class="total"> <strong>Subtotal:</strong> <span className="woocommerce-Price-amount amount"><span className="currencySymbol">&pound;</span>18.00</span> </p>
                  ...
                  <div className="gallery-thumb">
                    ...
                    <div class="gallery-overlay">
                      <div class="gallery-content">
                        <a href="/images/gallery/1.jpg" data-lightgallery="image" className="lightgallery-trigger"><i className="fa fa-plus"></i></a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-lg-4 col-md-6">
                <div class="gallery-item">
                  <div class="gallery-thumb">
                    ...
                    <div class="gallery-overlay">
                      <div class="gallery-content">
                        <a href="/images/gallery/2.jpg" data-lightgallery="image" className="lightgallery-trigger"><i className="fa fa-plus"></i></a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-lg-4 col-md-6">
                <div class="gallery-item">
                  <div class="gallery-thumb">
                    ...
                    <div class="gallery-overlay">
                      <div class="gallery-content">
                        <a href="/images/gallery/3.jpg" data-lightgallery="image" className="lightgallery-trigger"><i className="fa fa-plus"></i></a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-lg-4 col-md-6">
                <div class="gallery-item">
                  <div class="gallery-thumb">
                    ...
                    <div class="gallery-overlay">
                      <div class="gallery-content">
                        <a href="/images/gallery/4.jpg" data-lightgallery="image" className="lightgallery-trigger"><i className="fa fa-plus"></i></a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-lg-4 col-md-6">
                <div class="gallery-item">
                  <div class="gallery-thumb">
                    ...
                    <div class="gallery-overlay">
                      <div class="gallery-content">
                        <a href="/images/gallery/5.jpg" data-lightgallery="image" className="lightgallery-trigger"><i className="fa fa-plus"></i></a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-lg-4 col-md-6">
                <div class="gallery-item">
                  <div class="gallery-thumb">
                    ...
                    <div class="gallery-overlay">
                      <div class="gallery-content">
                        <a href="/images/gallery/6.jpg" data-lightgallery="image" className="lightgallery-trigger"><i className="fa fa-plus"></i></a>
                      </div>
                    </div>
                  </div>
                </div>
