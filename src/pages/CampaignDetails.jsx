              ...
              <div class="col-md-8">
                <div class="campaign-details">
                  ...
                  <div class="campaign-content">
                    <h3 class="title">Clean Energy for All</h3>
                ...
                <div class="sidebar-widget">
                  ...
                  <div class="donate-form">
                    <form action="#" method="post">
                      ...
                      <button type="submit" class="btn btn-theme-colored1 btn-flat btn-block">Donate</button>
                    </form>
                  </div>
                </div>
                <div class="sidebar-widget">
                  ...
                  <ul className="recent-post clearfix">
                    <li className="clearfix">
                      ...
                      <div class="post-data">
                        <h6 class="title"><Link to="/campaign-details">Save the Tigers</Link></h6>
                    ...
                    <li className="clearfix">
                      ...
                      <div class="post-data">
                        <h6 class="title"><Link to="/campaign-details">Fight Climate Change</Link></h6>
                        <p class="mb-0 date">01 Feb, 2021</p>
                      </div>
                    </li>
                    <li className="clearfix">
                      ...
                      <div class="post-data">
                        <h6 class="title"><Link to="/campaign-details">Protect Our Forests</Link></h6>
                        <p class="mb-0 date">01 Feb, 2021</p>
                      </div>
                    </li>
                  </ul>
