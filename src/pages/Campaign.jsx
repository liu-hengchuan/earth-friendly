            ...
            <div class="row">
              <div class="col-lg-4 col-md-6">
                <div class="campaign-block">
                  ...
                  <div class="campaign-content">
                    <h4 class="title"><Link to="/campaign-details">Clean Energy for All</Link></h4>
              ...
              <div class="col-lg-4 col-md-6">
                <div class="campaign-block">
                  ...
                  <div class="campaign-content">
                    <h4 class="title"><Link to="/campaign-details">Save the Tigers</Link></h4>
                    <p>Lorem ipsum dolor sit amet, notted consectetur adipisi elit sed do eiusmod temor sit amet dolor incididunt labore magna aliquaenim sed do eiusmod tempor incididunt.</p>
                    <div class="campaign-meta">
                      <span class="date"><i class="fa fa-calendar"></i> 01 Feb, 2021</span>
              ...
              <div class="col-lg-4 col-md-6">
                <div class="campaign-block">
                  ...
                  <div class="campaign-content">
                    <h4 class="title"><Link to="/campaign-details">Fight Climate Change</Link></h4>
                    <p>Lorem ipsum dolor sit amet, notted consectetur adipisi elit sed do eiusmod temor sit amet dolor incididunt labore magna aliquaenim sed do eiusmod tempor incididunt.</p>
                    <div class="campaign-meta">
                      <span class="date"><i class="fa fa-calendar"></i> 01 Feb, 2021</span>
              ...
              <div class="col-lg-4 col-md-6">
                <div class="campaign-block">
                  ...
                  <div class="campaign-content">
                    <h4 class="title"><Link to="/campaign-details">Protect Our Forests</Link></h4>
                    <p>Lorem ipsum dolor sit amet, notted consectetur adipisi elit sed do eiusmod temor sit amet dolor incididunt labore magna aliquaenim sed do eiusmod tempor incididunt.</p>
                    <div class="campaign-meta">
                      <span class="date"><i class="fa fa-calendar"></i> 01 Feb, 2021</span>
              ...
              <div class="col-lg-4 col-md-6">
                <div class="campaign-block">
                  ...
                  <div class="campaign-content">
                    <h4 class="title"><Link to="/campaign-details">Clean Our Oceans</Link></h4>
                    <p>Lorem ipsum dolor sit amet, notted consectetur adipisi elit sed do eiusmod temor sit amet dolor incididunt labore magna aliquaenim sed do eiusmod tempor incididunt.</p>
                    <div class="campaign-meta">
                      <span class="date"><i class="fa fa-calendar"></i> 01 Feb, 2021</span>
              ...
              <div class="col-lg-4 col-md-6">
                <div class="campaign-block">
                  ...
                  <div class="campaign-content">
                    <h4 class="title"><Link to="/campaign-details">Improve Air Quality</Link></h4>
                    <p>Lorem ipsum dolor sit amet, notted consectetur adipisi elit sed do eiusmod temor sit amet dolor incididunt labore magna aliquaenim sed do eiusmod tempor incididunt.</p>
                    <div class="campaign-meta">
                      <span class="date"><i class="fa fa-calendar"></i> 01 Feb, 2021</span>
